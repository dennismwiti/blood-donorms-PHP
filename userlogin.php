...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Perform database operations to check user credentials
    ...
    if ($row = mysqli_fetch_assoc($result)) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            if (isset($_SESSION['role']) && $_SESSION['role'] === 'donor') {
                ...
                header("Location: hospitallog/dashboard.php");
	...
	<div class="d-flex justify-content-center h-100">
		<div class="user_card">
			...
			<div class="d-flex justify-content-center form_container">
				<form action="userlogin.php" method="post">
					...
					<div class="d-flex justify-content-center mt-3 login_container">
						<button type="submit" name="userlogin" style="border-radius: 0%" class="btn login_btn">Login</button>
					</div>
				</form>
			</div>
			...
			<div class="mt-4">
				...
				<div class="d-flex justify-content-center links">
					<a href="./index.php" style="text-decoration:none; color: white">Back to Admin Panel</a>
				</div>
			</div>
		</div>
	</div>
