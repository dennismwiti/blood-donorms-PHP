            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="viewdonor.php"><i class="fa fa-edit fa-eye"></i> View users Details</a>
                        </li>
                        <li>
                            <a href="editview.php"><i class="fa fa-edit fa-fw"></i> Edit users Details</a>
                        </li>
                        <li>
                            <a href="deleteview.php"><i class="fa fa-user-times"></i> Delete users Details</a>
                        </li>
                        <li>
                            <a href="requestapproval.php"><i class="fa fa-user-times"></i> request approvals</a>
                        </li>
                        <li>
                            <a href="availableblood.php"><i class="fa fa-user-times"></i> available blood</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href=""><i class="fa fa-flag"></i> Camps <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="newcampaign.php">New Camps</a>
                                </li>
                                <li>
                                    <a href="viewcampaign.php">View Camps</a>
                                </li>
                                <li>
                                    <a href="updatecampaign.php">Update Camps</a>
                                </li>
                                <li>
                                    <a href="deletedcampaign.php">Delete Camps</a>
                                </li>
                            </ul>
                        </li>
