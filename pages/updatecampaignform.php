                                    ...
                                    <div class="col-lg-6">
                                        <form role="form" action="finaladdedcampaign.php" method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="camp_name" type="text" value='<?php echo $row['camp_name']; ?>' required>
                                            </div>
                                            <div class="form-group">
                                                <label>Organizer Name</label>
                                                <input class="form-control" type="text" name="organizers_name" value='<?php echo $row['organizers_name']; ?>' required>
                                            </div>
                                            <div class="form-group">
                                                <label>contact</label>
