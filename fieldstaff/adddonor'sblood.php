...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO blood(name, gender, dob, weight, bloodgroup, address, contact, bloodqty, collection)
              VALUES ('$name', '$gender', '$dob', '$weight', '$bloodgroup', '$address', '$contact', '$bloodqty', '$collection')";
    ...
    if (mysqli_query($con, $query)) {
        ...
        $errorMessage = 'Error inserting data into the database: ' . mysqli_error($con);
    }
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Blood Donor's Details</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
