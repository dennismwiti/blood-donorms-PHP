    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                <?php
                    // Check if $name variable is defined
                    if (isset($username)) {
                        echo '<h1 class="page-header">WELCOME ' . $username . '</h1>';
                    } else {
                        echo '<h1 class="page-header">WELCOME</h1>';
                    }
                ?>
                </div>
                <!-- /.col-lg-12 -->
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <?php include 'counter/dashboarddonorcount.php';?> 
                                    
                                    <div>Available Blood</div>
                                </div>
                            </div>
                        </div>
                        <a href="viewbloodcollection.php">
                            <div class="panel-footer">
                                <span class="pull-left">View no of blood donated</span>
                    ...
                    <div class="panel panel-warning">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <!-- in order to count total donor's record -->
                                        <?php include 'counter/dashboardcampcount.php';?> 

                                    <!-- <div class="huge">26</div> -->
                                    <div>Camps Details</div>
                                </div>
                            </div>
                        </div>
                        
                        <a href="viewcamps.php">
                            <div class="panel-footer">
                                <span class="pull-left">View Available Camps</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                            </div>
                        </a>
                    ...
                    <div class="panel panel-yellow">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                <?php include 'counter/dashannouncement.php';?>
                                    <div class="huge"> </div>
                                    <div>Announcement</div>
                                </div>
                            </div>
                        </div>
                        <a href="viewannouncements.php">
                            <div class="panel-footer">
