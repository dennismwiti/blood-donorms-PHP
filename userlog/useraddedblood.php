                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							if(isset($_POST['name'])){
								...
								$qry = "insert into blood(name,gender,dob,weight,bloodgroup,address,bloodqty,collection) values ('$name','$gender','$dob','$weight','$bloodgroup','$address','$bloodqty','$collection')";
