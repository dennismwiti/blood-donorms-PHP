                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="useraddedblood.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="phonenumber" type="number" name="number" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Gender</label>
                                            <input class="form-control" type="text" placeholder="male or female" name="gender" required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="bloodqty" pattern="[0-9]+" required>
                                        </div>
                                        <div class="form-group">
...
<footer>
        <p>&copy; <?php echo date("Y"); ?>: Developed By Dennis Mwiti</p>
    </footer>
